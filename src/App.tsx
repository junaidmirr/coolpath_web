          ...
          <div className="settings-modal" style={{ background: theme.bg, border: `1px solid ${theme.border}` }} onClick={e => e.stopPropagation()}>
            ...
            <div style={{ overflowY: 'auto', flex: 1 }}>
              ...
              <div style={{ padding: '14px 20px', borderBottom: `1px solid ${theme.border}` }}>
                ...
                <div style={{ fontSize: 12, color: theme.textSecondary, marginBottom: 8 }}>Override default Google Cloud server endpoint</div>
                <div style={{ display: 'flex', gap: 8 }}>
                  <input value={customBackendUrl} onChange={e => setCustomBackendUrl(e.target.value)} placeholder="https://coolpath.run.app"
